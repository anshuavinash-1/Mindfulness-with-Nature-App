...
class _ActivitiesPageState extends State<ActivitiesPage>
  ...
  final List<Map<String, dynamic>> activities = [
    ...
    {"name": "Feeling Lighter", "icon": Icons.air, "color": const Color(0xFFA4C3B2)},
    {
      "name": "Connecting with Nature",
      "icon": Icons.nature_people,
      "color": const Color(0xFF88AB8E)
    },
    {"name": "Gratitude", "icon": Icons.favorite, "color": const Color(0xFFEAB8A3)},
    {
    ...
    },
    {
      ...
      "color": const Color(0xFF8D9B6A)
    },
    {"name": "Joyfulness", "icon": Icons.wb_sunny, "color": const Color(0xFFFFD89C)},
    {
      "name": "Playfulness",
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              const Color(0xFF1A4D2E).withValues(alpha: 0.95),
              const Color(0xFF0F2922).withValues(alpha: 0.95),
            ],
          ),
        ...
        children: [
          ...
          SliderTheme(
            data: SliderThemeData(
              ...
              inactiveTrackColor: const Color(0xFF81C784).withValues(alpha: 0.3),
                ...
                colors: isSessionActive
                    ? [
                        ...
                        selectedColor?.withValues(alpha: 0.1) ??
                            const Color(0xFFA5D6A7).withValues(alpha: 0.1),
                      ]
                    : [
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: canStart
                  ...
                  : null,
              color: canStart ? null : const Color(0xFF81C784).withValues(alpha: 0.3),
              borderRadius: BorderRadius.circular(30),
              boxShadow: canStart
                  ? [
                      BoxShadow(
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: (selectedColor ?? const Color(0xFF4CAF50)).withValues(alpha: 0.2),
            borderRadius: BorderRadius.circular(25),
            border: Border.all(
              color:
