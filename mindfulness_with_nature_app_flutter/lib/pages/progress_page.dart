        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: completed
                ...
                : const Color(0xFF374834).withValues(alpha: 0.3),
            width: completed ? 2 : 1,
          ),
        ),
        child: Row(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: completed
                    ...
                    : const Color(0xFF374834).withValues(alpha: 0.1),
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: completed
                          ...
                          : const Color(0xFF374834).withValues(alpha: 0.6),
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: completed
                          ? const Color(0xFF4CAF50)
                          : const Color(0xFF374834).withValues(alpha: 0.5),
                    ),
                  ),
                ],
              ),
